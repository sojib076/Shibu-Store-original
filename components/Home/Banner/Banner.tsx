            ...
            <section className="py-10 sm:py-16 lg:py-24">
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                        <div>
                            <h1 className="text-4xl font-bold text-black sm:text-6xl lg:text-7xl banner">
                            দেখুন অনলাইন 
                                <div className="relative inline-flex">
                                    <span className="absolute inset-x-0 bottom-0 border-b-[30px] border-[#4ADE80]"></span>
                                    <h1 className="relative text-4xl font-bold text-black sm:text-6xl lg:text-7xl"> কিনুন অফলাইনে</h1>
                                </div>
                            </h1>
                            ...
                            <div className="mt-10 sm:flex sm:items-center sm:space-x-8">
                                <a href="https://goo.gl/maps/pLcdV3o3FAttZTnq8" target={"_blank"} title="" className="inline-flex items-center justify-center px-10 py-4 text-base font-semibold text-white transition-all duration-200 bg-orange-500 hover:bg-orange-600 focus:bg-orange-600" role="button">
...
// pt-24 pb-10 sm:pt-32 sm:pb-16 lg:pb-24 for every section of the page (padding top and bottom)